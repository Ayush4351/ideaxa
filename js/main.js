$(document).ready(function () {
  ...
  $(".active-banner-slider").owlCarousel({
    ...
    nav: true,
    navText: [
      "<img src='img/banner/arrow-prev.png'>",
      "<img src='img/banner/arrow-next.png'>",
    ],
    dots: false,
  });
...
function activateContent() {
  ...
  const learnButton = document.querySelector("#learn_btn");
  const dots = document.querySelector("#dots");
  hiddenContent.classList.toggle("hidden");
  if (hiddenContent.className !== "hidden-text hidden") {
    dots.style.display = "none";
    learnButton.innerHTML = "Read Less";
  } else {
    dots.style.display = "inline";
    learnButton.innerHTML = "Read More";
  }
}
...
$(".categories__slider").owlCarousel({
  ...
  dots: false,
  nav: true,
  navText: ["<img src='img/products/prev.png'>","<img src='img/products/next.png'>"],
  // animateOut: 'fadeOut',
  // animateIn: 'fadeIn',
  smartSpeed: 1200,
  autoHeight: false,
